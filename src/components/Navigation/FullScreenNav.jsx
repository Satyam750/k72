...
const handleProjectRoutes = () => {
 navigate("/project")
  setNavOpen(false)
  
}
const handleAgenceRoutes = () => {
 navigate("/agence")
  setNavOpen(false)
      ...
      <div className='h-screen w-full fixed'>
         ...
         <div className="navlink flex w-full justify-between lg:p-5 p-2 items-start  ">
           ...
           <Link to={"/"} onClick={()=>{setNavOpen(false)}}>
                    ...
                    <div onClick={() => {
                        setNavOpen(false)}} className='lg:h-24 h-20 w-20 lg:w-32 relative cursor-pointer cross'>
        ...
        <div className="link origin-top relative border-t-1 border-white" onClick={handleProjectRoutes}>
          ...
          <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
            <div className="moveX flex items-center">
              ...
              <img
                className="lg:h-28 h-14 rounded-full shrink-0 lg:w-72 w-32 object-cover"
        ...
        <div className="link origin-top relative border-t-1 border-white" onClick={handleAgenceRoutes}>
          <h1 className="font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase">
